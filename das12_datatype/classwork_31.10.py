...
project_query = """ CREATE TABLE IF NOT EXISTS project (
...
# # # Filling the project table with values
# # # query:
# insert_query = """ INSERT INTO project(id, name, begin_date, end_date)
