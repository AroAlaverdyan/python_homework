...
# 			if circle+1 != len(self.list_) and i + self.list_[circle+1] == self.target:	
# 				print(f"\nWhen you sum the {circle+1}th and {circle+2}th numbers of {self.list_},\
#  you will get your target value: {self.target}= {self.list_[circle]}+{self.list_[circle+1]}")
# 				break
